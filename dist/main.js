...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  margin: 0;\n  background-color: black;\n}\n\nbody {\n  margin: 0;\n  display: flex;\n  flex-direction: column;\n  justify-items: center;\n  align-items: center;\n}\n\n@keyframes marcosclave {\n  from {\n    opacity: 0.5;\n  }\n  to {\n    opacity: 1;\n  }\n}\n\nh1 {\n  margin: 0.5rem;\n  padding: 0;\n  font-size: 1.5rem;\n  text-align: center;\n  color: orangered;\n  text-shadow: 0 0 0.5rem violet;\n  animation: marcosclave 2s linear 0s infinite alternate;\n}\n\n.board {\n  width: calc(100vmin - 5rem);\n  display: grid;\n  grid-template-columns: repeat(8, 1fr);\n  grid-template-rows: repeat(8, 1fr);\n}\n\n.board div {\n  aspect-ratio: 1;\n  border-style: solid;\n  border-radius: 0.4rem;\n  border-width: 0;\n  color: black;\n  align-items: center;\n\n  display: flex;\n  justify-content: center;\n}\n\n.board div img {\n  position: relative;\n  height: 90%;\n}\n\n.board .white {\n  height: calc((100vmin - 5rem) / 8);\n  background-color: rgb(128, 64, 255);\n  box-shadow: 0 0 0.5rem black inset;\n}\n\n.board .black {\n  height: calc((100vmin - 5rem) / 8);\n  background-color: rgb(64, 0, 128);\n  box-shadow: 0 0 0.5rem black inset;\n}\n\n.board .horse {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: 100%;\n  background-repeat: no-repeat;\n  background-position: center;\n  color: orangered;\n  font-size: 1.5rem;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,uBAAuB;AACzB;;AAEA;EACE,SAAS;EACT,aAAa;EACb,sBAAsB;EACtB,qBAAqB;EACrB,mBAAmB;AACrB;;AAEA;EACE;IACE,YAAY;EACd;EACA;IACE,UAAU;EACZ;AACF;;AAEA;EACE,cAAc;EACd,UAAU;EACV,iBAAiB;EACjB,kBAAkB;EAClB,gBAAgB;EAChB,8BAA8B;EAC9B,sDAAsD;AACxD;;AAEA;EACE,2BAA2B;EAC3B,aAAa;EACb,qCAAqC;EACrC,kCAAkC;AACpC;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,qBAAqB;EACrB,eAAe;EACf,YAAY;EACZ,mBAAmB;;EAEnB,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,kCAAkC;EAClC,mCAAmC;EACnC,kCAAkC;AACpC;;AAEA;EACE,kCAAkC;EAClC,iCAAiC;EACjC,kCAAkC;AACpC;;AAEA;EACE,yDAAkC;EAClC,qBAAqB;EACrB,4BAA4B;EAC5B,2BAA2B;EAC3B,gBAAgB;EAChB,iBAAiB;AACnB","sourcesContent":["html {\n  margin: 0;\n  background-color: black;\n}\n\nbody {\n  margin: 0;\n  display: flex;\n  flex-direction: column;\n  justify-items: center;\n  align-items: center;\n}\n\n@keyframes marcosclave {\n  from {\n    opacity: 0.5;\n  }\n  to {\n    opacity: 1;\n  }\n}\n\nh1 {\n  margin: 0.5rem;\n  padding: 0;\n  font-size: 1.5rem;\n  text-align: center;\n  color: orangered;\n  text-shadow: 0 0 0.5rem violet;\n  animation: marcosclave 2s linear 0s infinite alternate;\n}\n\n.board {\n  width: calc(100vmin - 5rem);\n  display: grid;\n  grid-template-columns: repeat(8, 1fr);\n  grid-template-rows: repeat(8, 1fr);\n}\n\n.board div {\n  aspect-ratio: 1;\n  border-style: solid;\n  border-radius: 0.4rem;\n  border-width: 0;\n  color: black;\n  align-items: center;\n\n  display: flex;\n  justify-content: center;\n}\n\n.board div img {\n  position: relative;\n  height: 90%;\n}\n\n.board .white {\n  height: calc((100vmin - 5rem) / 8);\n  background-color: rgb(128, 64, 255);\n  box-shadow: 0 0 0.5rem black inset;\n}\n\n.board .black {\n  height: calc((100vmin - 5rem) / 8);\n  background-color: rgb(64, 0, 128);\n  box-shadow: 0 0 0.5rem black inset;\n}\n\n.board .horse {\n  background-image: url(./horse.svg);\n  background-size: 100%;\n  background-repeat: no-repeat;\n  background-position: center;\n  color: orangered;\n  font-size: 1.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
